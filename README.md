# Awesome CakePHP [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 438,982 | 🐛 70 | 📅 2026-01-28 with stars
...
* the [CakePHP 2.x version](https://github.com/FriendsOfCake/awesome-cakephp/tree/cake2) ⭐ 930 | 🐛 0 | 📅 2026-02-17 of this awesome list
* the [CakePHP 3.x version](https://github.com/FriendsOfCake/awesome-cakephp/tree/cake3) ⭐ 930 | 🐛 0 | 📅 2026-02-17 of this awesome list
* the [CakePHP 4.x version](https://github.com/FriendsOfCake/awesome-cakephp/tree/cake4) ⭐ 930 | 🐛 0 | 📅 2026-02-17 of this awesome list
* this wiki with a [list of not-yet upgraded plugins](https://github.com/FriendsOfCake/awesome-cakephp/wiki#plugins-not-yet-upgraded-from-2x-to-3x) ⭐ 930 | 🐛 0 | 📅 2026-02-17

Additional lists you might find useful:

* [Awesome Awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,231 | 🐛 43 | 🌐 Ruby | 📅 2024-06-02
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,378 | 🐛 69 | 📅 2026-01-17
...
* [AuditStash plugin](https://github.com/dereuromark/cakephp-audit-stash) ⭐ 4 | 🐛 2 | 🌐 PHP | 📅 2026-02-18 - Flexible and rock solid audit log tracking.
...
* [Tools:Passwordable](https://github.com/dereuromark/cakephp-tools) ⭐ 335 | 🐛 2 | 🌐 PHP | 📅 2026-02-09 - Containing [Passwordable behavior](https://github.com/dereuromark/cakephp-tools/blob/master/docs/Behavior/Passwordable.md) ⭐ 335 | 🐛 2 | 🌐 PHP | 📅 2026-02-09 for a DRY approach on password hashing.
...
* [Authorization plugin](https://github.com/cakephp/authorization) ⭐ 74 | 🐛 0 | 🌐 PHP | 📅 2026-02-14 - Official CakePHP authorization stack.
...
* [TwoFactorAuth plugin](https://github.com/andrej-griniuk/cakephp-two-factor-auth) ⭐ 38 | 🐛 5 | 🌐 PHP | 📅 2025-11-10 - Allows two factor authentication using Google Authenticator or similar app to generate one-time codes. Based on [RobThree/TwoFactorAuth](https://github.com/RobThree/TwoFactorAuth) ⭐ 1,171 | 🐛 4 | 🌐 PHP | 📅 2026-01-05 library.
...
* [IdeHelper plugin](https://github.com/dereuromark/cakephp-ide-helper) ⭐ 186 | 🐛 5 | 🌐 PHP | 📅 2026-02-06 - Helps to make IDE support better by adding annotations to your existing code similar to what baking does to new code.
...
* [DebugKit plugin](https://github.com/cakephp/debug_kit) ⭐ 843 | 🐛 0 | 🌐 PHP | 📅 2026-01-05 - The de-facto standard for debugging.
...
* [CakephpWhoops plugin](https://github.com/dereuromark/cakephp-whoops) ⭐ 14 | 🐛 1 | 🌐 PHP | 📅 2023-10-12 - PHP errors and exceptions for cool kids with [filp/whoops](https://github.com/filp/whoops) ⭐ 13,245 | 🐛 9 | 🌐 PHP | 📅 2025-11-28.
...
* [Josegonzalez/Upload plugin](https://github.com/FriendsOfCake/cakephp-upload) ⭐ 544 | 🐛 10 | 🌐 PHP | 📅 2026-02-16 - A customisable plugin that uses [Flysystem](https://flysystem.thephpleague.com/) to write to multiple backends (Dropbox, FTP, S3, Local, etc.).
* [FileStorage plugin](https://github.com/dereuromark/cakephp-file-storage) ⭐ 9 | 🐛 1 | 🌐 PHP | 📅 2026-02-07 - Flexible file storage and upload plugin.
...
* [Translate plugin](https://github.com/dereuromark/cakephp-translate) ⭐ 17 | 🐛 3 | 🌐 PHP | 📅 2026-02-15 - Translate your translations in the backend with ease.
...
* [Chronos](https://github.com/cakephp/chronos) ⭐ 1,360 | 🐛 6 | 🌐 PHP | 📅 2026-02-14 - A simple standalone DateTime API extension (successor of Carbon).
...
* [Migrations plugin](https://github.com/cakephp/migrations) ⭐ 138 | 🐛 7 | 🌐 PHP | 📅 2026-02-20 - (DB) Migration plugin.
* [Upgrade app](https://github.com/cakephp/upgrade) ⭐ 111 | 🐛 2 | 🌐 PHP | 📅 2026-02-19 - Official upgrade app for 3.x=>4.x and 4.x=>5.x.
...
* [Tools plugin](https://github.com/dereuromark/cakephp-tools) ⭐ 335 | 🐛 2 | 🌐 PHP | 📅 2026-02-09 - Containing lots of useful helpers, behaviors, components, commands, helpers, libs and more.
...
* [CakePdf plugin](https://github.com/FriendsOfCake/CakePdf) ⭐ 376 | 🐛 3 | 🌐 PHP | 📅 2025-01-30 - A plugin around PDF generation.
...
* [SwaggerBake plugin](https://github.com/cnizzardini/cakephp-swagger-bake) ⭐ 60 | 🐛 1 | 🌐 PHP | 📅 2026-02-15 - This plugin automatically builds OpenAPI from your existing models and routes for display in Swagger and Redoc.
...
* [Captcha plugin](https://github.com/dereuromark/cakephp-captcha) ⭐ 8 | 🐛 0 | 🌐 PHP | 📅 2026-02-14 - Simple, unobtrusive and extendable captcha solution providing by default an image based math captcha.

## SEO

*Search Engine Optimization.*

* [Tools:Slugged](https://github.com/dereuromark/cakephp-tools) ⭐ 335 | 🐛 2 | 🌐 PHP | 📅 2026-02-09 - Containing Slugged behavior to auto-generate URL-compatible slugs from titles.
...
* [App template](https://github.com/cakephp/app) ⭐ 383 | 🐛 3 | 🌐 PHP | 📅 2026-02-13 - An empty CakePHP project for use with composer.
...
* [BootstrapUI plugin](https://github.com/friendsofcake/bootstrap-ui) ⭐ 349 | 🐛 4 | 🌐 PHP | 📅 2026-02-19 - Bootstrap 4/5 integration.
* [Tools:Tree](https://github.com/dereuromark/cakephp-tools) ⭐ 335 | 🐛 2 | 🌐 PHP | 📅 2026-02-09 - Tree helper to work with Core Tree behavior and handle tree structure output.
* [CsvView plugin](https://github.com/FriendsOfCake/cakephp-csvview) ⭐ 176 | 🐛 3 | 🌐 PHP | 📅 2025-04-23 - A view class to easily generate CSV.
* [Bake plugin](https://github.com/cakephp/bake) ⭐ 111 | 🐛 0 | 🌐 PHP | 📅 2026-02-13 - Provides code generation functionality.
...
* [LatteView plugin](https://github.com/josbeir/cakephp-latte-view) ⭐ 2 | 🐛 0 | 🌐 PHP | 📅 2025-12-17 - A plugin providing Latte template engine integration.
...
* [CakephpFixtureFactories plugin](https://github.com/dereuromark/cakephp-fixture-factories) ⭐ 1 | 🐛 1 | 🌐 PHP | 📅 2026-02-16 - Create your fixtures dynamically on a test basis, accelerate the writing and maintenance of your tests.
...
* [CakePHP Docker Setup](https://github.com/cpierce/cakephp-docker-setup) ⭐ 0 | 🐛 0 | 🌐 Smarty | 📅 2026-02-16 - Tool for spinning up multiple CakePHP vanilla dev environments using Docker.
...
IDE specific compatibility information and tips can be found [here](https://github.com/dereuromark/cakephp-ide-helper/wiki#ide-support-and-tips) ⭐ 186 | 🐛 5 | 🌐 PHP | 📅 2026-02-06.

## Web Applications

## CMS and applications built on CakePHP

* [baserCMS](https://github.com/baserproject/basercms) ⭐ 189 | 🐛 308 | 🌐 PHP | 📅 2026-02-19 - This is a website development framework with RESTful APIs. Installable as a plugin for CakePHP.

## Demo

*Web-based (demo) applications and tools.*

* [RealWorld](https://github.com/gothinkster/cakephp-realworld-example-app) ⚠️ Archived - Example CakePHP codebase containing real world examples (CRUD, auth, advanced patterns and more) that adheres to the [RealWorld](https://github.com/gothinkster/realworld-example-apps) ⭐ 82,862 | 🐛 41 | 🌐 Bru | 📅 2026-02-20 spec and API.
...
* [Top 10 (and more) core contributors](https://github.com/cakephp/cakephp/graphs/contributors) ⭐ 8,789 | 🐛 27 | 🌐 PHP | 📅 2026-02-20 - Give 'em a hand.
...
awesome-cakephp has been created by [dereuromark](https://github.com/dereuromark) and is currently maintained by him and the FriendsOfCake group. Thank you to all [contributors](https://github.com/FriendsOfCake/awesome-cakephp/graphs/contributors) ⭐ 930 | 🐛 0 | 📅 2026-02-17, too.
